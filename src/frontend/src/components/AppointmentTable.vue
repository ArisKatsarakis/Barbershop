  ...
  <b-container class="bv-example-row">
    <b-row align-h="between" class="shadow" style="margin-bottom: 10px;">
      <b-col align-self="start" cols="4">
        ...
        <b-form-datepicker @input="getDate()" id="example-datepicker" v-model="calendarDate" class="mb-2"
...
export default {
  ...
  methods: {
    ...
    async next() {
      ...
      this.value = new_date;
      this.calendarDate = this.value.getFullYear().toString() + "-" + (this.value.toLocaleString("default", {month: "2-digit"})) + "-" + this.value.toLocaleString("default", {day: "2-digit"});
